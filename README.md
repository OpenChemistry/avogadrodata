# ![Avogadro 2][Avogadro2Logo] Avogadro 2 Data Files
...
This repository includes test files and data for Avogadro, including
XML test scripts, and file format tests both valid and invalid.
